...
import {getJobPostAction} from "../../../store/actions/jobPostAction";

const JobPostForm = (props) => {
  const theme = useTheme();
  const classes = JobPostFormStyle(theme);
  const {allJobSkills, userSkills} = props
...
const mapStateToProps = (state) => {
  return {
    allJobSkills: state.jobPost.allJobSkills,
  }
}
